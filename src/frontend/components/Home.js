...
const Home = ({ marketplace, nft }) => {
  ...
  const redirectToFuto = () => {
    window.location.href = "https://futo.edu.ng/";
  };
          ...
          <Stack gap={3} className="">
            <div className="p-2">
              <h1 className="text-white">
                {" "}
                Welcome To Federal Univeristy Of Owerri
              </h1>
            </div>
            <div>
              <p className="text-white font-3xl">
                Make education your dream and it will help you to fufill your
                dream
              </p>
            </div>
